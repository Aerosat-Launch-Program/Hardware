...
while True:
    ...
    print(" ")
    #BMP280
    print(f"BMP_Temperature: {data.temperature:.2f} °C")
    print(f"BMP_Pressure: {data.pressure:.2f} hPa")
    print(f"BMP_Humidity: {data.humidity:.2f} %")
    print(" ")
    #AHT10
    # Read temperature and humidity from AHT10 sensor
    # Print sensor data
    print("AHT_Temperature: {:.2f} °C".format(temperature))
    print("AHT_Humidity: {:.2f} %".format(humidity))
    print("----------------------------------------------- ")
